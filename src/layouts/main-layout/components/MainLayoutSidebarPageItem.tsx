...
import { MINI_DRAWER_WIDTH } from "../helpers/helper";

export interface MainLayoutSidebarPageItemProps {
  id: string;
  title: string;
...
export default function MainLayoutSidebarPageItem({
  id,
  title,
  icon,
  href,
  ...
  disabled = false,
  nestedNavigation,
}: MainLayoutSidebarPageItemProps) {
